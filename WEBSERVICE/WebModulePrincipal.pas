...
uses
  ...
  Datasnap.DSProxyJavaScript, Datasnap.DSClientMetadata,
  Datasnap.DSCommonServer, IndyPeerImpl;
...
uses ServerMethodsPrin, Web.WebReq;
...
begin
  PersistentClass := ServerMethodsPrin.TServerMethods1;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := ServerMethodsPrin.TServerMethods1.ClassName
